...
import laboratorypublisher.LaboratoryTest;


public class SubActivator implements BundleActivator {
 
	ServiceReference laboratoryservice;

	public void start(BundleContext context) throws Exception {
		
		System.out.println("Start Online Laboratory Subscriber !");
	
		laboratoryservice= context.getServiceReference(LaboratoryTest.class.getName());
		LaboratoryTest cakeDeliveryPublisher = (LaboratoryTest) context.getService(laboratoryservice);
		...
		while (opt1 == 1) {
			...
			if (opt2 == 1) {
				...
				System.out.println("");
				cakeDeliveryPublisher.LaboratoryTest();
				System.out.println("");
...
public void stop(BundleContext context) throws Exception {
	...
	System.out.println("Stop Online Laboratory subscriber !");
	context.ungetService(laboratoryservice);
